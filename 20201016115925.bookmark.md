# GitHub - xwmx/nb: CLI plain-text note-taking, bookmarking, and archiving with encryption, filtering and search, Git-backed versioning and syncing, Pandoc-backed conversion, and more in a single portable script. (github.com)
...
[![\@xwmx](https://avatars0.githubusercontent.com/u/1246?s=60&u=1540f9ac501b5128fb9e21d454bfedc0ace5f772&v=4){.avatar-user width="24" height="24"}](/xwmx){.avatar .avatar-user}
...
[plugins](/xwmx/nb/tree/master/plugins "plugins"){#63dc9087c660611bdf3fcb1a1257247a-5d8ac37d7d68e84a964f15e845678f1e8cd97bf0 .js-navigation-open .link-gray-dark}
...
`nb` has an interactive shell that can be started with [`nb shell`](#shell), `nb -i`, or `nb --interactive`:
...
### [](#shortcut-aliases){#user-content-shortcut-aliases .anchor}Shortcut Aliases
...
### [](#help){#user-content-help .anchor}Help

[nb](#nb-help) • [bookmark](#bookmark-help) • [subcommands](#subcommands) • [plugins](#plugins-1)

#### [](#nb-help){#user-content-nb-help .anchor}`nb help`
...
#### [](#bookmark-help){#user-content-bookmark-help .anchor}`bookmark help`
...
### [](#subcommands){#user-content-subcommands .anchor}Subcommands

[add](#add) • [bookmark](#bookmark) • [completions](#completions) • [count](#count) • [delete](#delete) • [edit](#edit) • [env](#env) • [export](#export) • [git](#git) • [help](#help-1) • [history](#history) • [import](#import) • [init](#init) • [list](#list) • [ls](#ls) • [move](#move) • [notebooks](#notebooks) • [open](#open) • [peek](#peek) • [plugins](#plugins) • [remote](#remote) • [rename](#rename) • [run](#run) • [search](#search) • [settings](#settings) • [shell](#shell) • [show](#show) • [status](#status) • [subcommands](#subcommands-1) • [sync](#sync) • [update](#update) • [use](#use) • [version](#version)

#### [](#add){#user-content-add .anchor}`add`
...
#### [](#bookmark){#user-content-bookmark .anchor}`bookmark`
...
#### [](#completions){#user-content-completions .anchor}`completions`
...
#### [](#count){#user-content-count .anchor}`count`
...
#### [](#delete){#user-content-delete .anchor}`delete`
...
#### [](#edit){#user-content-edit .anchor}`edit`
...
#### [](#env){#user-content-env .anchor}`env`
...
#### [](#export){#user-content-export .anchor}`export`
...
#### [](#git){#user-content-git .anchor}`git`
...
#### [](#help-1){#user-content-help-1 .anchor}`help`
...
#### [](#history){#user-content-history .anchor}`history`
...
#### [](#import){#user-content-import .anchor}`import`
...
#### [](#init){#user-content-init .anchor}`init`
...
#### [](#list){#user-content-list .anchor}`list`
...
#### [](#move){#user-content-move .anchor}`move`
...
#### [](#open){#user-content-open .anchor}`open`
...
#### [](#peek){#user-content-peek .anchor}`peek`
...
#### [](#remote){#user-content-remote .anchor}`remote`
...
#### [](#rename){#user-content-rename .anchor}`rename`
...
#### [](#run){#user-content-run .anchor}`run`
...
#### [](#settings){#user-content-settings .anchor}`settings`
...
##### [](#auto_sync){#user-content-auto_sync .anchor}`auto_sync`
...
##### [](#color_primary){#user-content-color_primary .anchor}`color_primary`
...
##### [](#color_secondary){#user-content-color_secondary .anchor}`color_secondary`
...
##### [](#color_theme){#user-content-color_theme .anchor}`color_theme`
...
##### [](#default_extension){#user-content-default_extension .anchor}`default_extension`
...
##### [](#editor){#user-content-editor .anchor}`editor`
...
##### [](#encryption_tool){#user-content-encryption_tool .anchor}`encryption_tool`
...
##### [](#footer){#user-content-footer .anchor}`footer`
...
##### [](#header){#user-content-header .anchor}`header`
...
##### [](#limit){#user-content-limit .anchor}`limit`
...
##### [](#nb_dir){#user-content-nb_dir .anchor}`nb_dir`
...
##### [](#syntax_theme){#user-content-syntax_theme .anchor}`syntax_theme`
...
#### [](#shell){#user-content-shell .anchor}`shell`
...
#### [](#show){#user-content-show .anchor}`show`
...
#### [](#status){#user-content-status .anchor}`status`
...
#### [](#subcommands-1){#user-content-subcommands-1 .anchor}`subcommands`
...
#### [](#sync){#user-content-sync .anchor}`sync`
...
#### [](#update){#user-content-update .anchor}`update`
...
#### [](#use){#user-content-use .anchor}`use`
...
#### [](#version){#user-content-version .anchor}`version`
...
### [](#plugins-1){#user-content-plugins-1 .anchor}Plugins

[backlink](#backlink) • [copy](#copy) • [ebook](#ebook) • [example](#example)

#### [](#backlink){#user-content-backlink .anchor}`backlink`
...
#### [](#copy){#user-content-copy .anchor}`copy`
...
#### [](#ebook){#user-content-ebook .anchor}`ebook`
...
#### [](#example){#user-content-example .anchor}`example`
...
[](#specifications){#user-content-specifications .anchor}Specifications
-----------------------------------------------------------------------

### [](#nb-markdown-bookmark-file-format){#user-content-nb-markdown-bookmark-file-format .anchor}`nb` Markdown Bookmark File Format

#### [](#extension){#user-content-extension .anchor}Extension

`.bookmark.md`

#### [](#description){#user-content-description .anchor}Description
...
#### [](#example-1){#user-content-example-1 .anchor}Example
...
#### [](#elements){#user-content-elements .anchor}Elements

##### [](#title){#user-content-title .anchor}Title

`Optional`

A markdown `h1` heading containing the content of the bookmarked page\'s HTML `<title>` or [`og:title`](https://ogp.me/) tag, if present, followed by the domain within parentheses.

###### [](#examples){#user-content-examples .anchor}Examples

    # Example Title (example.com)

    # (example.com)

##### [](#url){#user-content-url .anchor}URL
...
A text element containing the content of the bookmarked page\'s meta description or [`og:description`](https://ogp.me/) tag, if present.

##### [](#-quote){#user-content--quote .anchor}`## Quote`

`Optional`

A markdown quote block containing a user-specified excerpt from the bookmarked resource.

##### [](#-comment){#user-content--comment .anchor}`## Comment`

`Optional`

A text element containing a comment written by the user.

##### [](#-related){#user-content--related .anchor}`## Related`

`Optional`

A Markdown list of angle bracketed (`<`, `>`) URLs that are related to the bookmarked resource.

##### [](#-tags){#user-content--tags .anchor}`## Tags`

`Optional`

A list of tags represented as hashtags separated by individual spaces.

##### [](#-content){#user-content--content .anchor}`## Content`
...
##### [](#-source){#user-content--source .anchor}`## Source`
...
### [](#nb-notebook-specification){#user-content-nb-notebook-specification .anchor}`nb` Notebook Specification
...
#### [](#index-file){#user-content-index-file .anchor}`.index` File
...
##### [](#operations){#user-content-operations .anchor}Operations
...
##### [](#index-subcommand){#user-content-index-subcommand .anchor}`index` Subcommand

`nb` manages the `.index` using an internal `index` subcommand.

###### [](#nb-help-index){#user-content-nb-help-index .anchor}`nb help index`
...
#### [](#archived-notebooks){#user-content-archived-notebooks .anchor}Archived Notebooks

A notebook is considered archived when it contains a file named `.archived` at the root level of the notebook directory.

[](#tests){#user-content-tests .anchor}Tests
--------------------------------------------

To run the [test suite](/xwmx/nb/blob/master/test), install [Bats](https://github.com/bats-core/bats-core) and run `bats test` in the project root.

------------------------------------------------------------------------

Copyright (c) 2015-present [William Melody](https://www.williammelody.com/) • See LICENSE for details.
...
[notes](/topics/notes "Topic: notes"){.topic-tag .topic-tag-link} [bash](/topics/bash "Topic: bash"){.topic-tag .topic-tag-link} [shell](/topics/shell "Topic: shell"){.topic-tag .topic-tag-link} [productivity](/topics/productivity "Topic: productivity"){.topic-tag .topic-tag-link} [command-line](/topics/command-line "Topic: command-line"){.topic-tag .topic-tag-link} [cli](/topics/cli "Topic: cli"){.topic-tag .topic-tag-link} [sync](/topics/sync "Topic: sync"){.topic-tag .topic-tag-link} [note-taking](/topics/note-taking "Topic: note-taking"){.topic-tag .topic-tag-link} [emacs](/topics/emacs "Topic: emacs"){.topic-tag .topic-tag-link} [vim](/topics/vim "Topic: vim"){.topic-tag .topic-tag-link} [vscode](/topics/vscode "Topic: vscode"){.topic-tag .topic-tag-link} [git](/topics/git "Topic: git"){.topic-tag .topic-tag-link} [pandoc](/topics/pandoc "Topic: pandoc"){.topic-tag .topic-tag-link} [notebook](/topics/notebook "Topic: notebook"){.topic-tag .topic-tag-link} [bookmarks](/topics/bookmarks "Topic: bookmarks"){.topic-tag .topic-tag-link} [tagging](/topics/tagging "Topic: tagging"){.topic-tag .topic-tag-link} [knowledge-base](/topics/knowledge-base "Topic: knowledge-base"){.topic-tag .topic-tag-link} [archiving](/topics/archiving "Topic: archiving"){.topic-tag .topic-tag-link} [bookmark-manager](/topics/bookmark-manager "Topic: bookmark-manager"){.topic-tag .topic-tag-link} [notes-app](/topics/notes-app "Topic: notes-app"){.topic-tag .topic-tag-link}
...
[Releases](/xwmx/nb/releases){.link-gray-dark .no-underline} {#releases .h4 .mb-3}
------------------------------------------------------------

230 tags

[Contributors 4](/xwmx/nb/graphs/contributors){.link-gray-dark .no-underline} {#contributors-4 .h4 .mb-3}
-----------------------------------------------------------------------------

-   [![\@xwmx](https://avatars0.githubusercontent.com/u/1246?s=64&v=4){.d-block .avatar-user width="32" height="32"}](/xwmx){.mr-2} [**xwmx** William Melody](/xwmx){.link-gray-dark .no-underline .flex-self-center}
-   [![\@heywoodlh](https://avatars1.githubusercontent.com/u/18178614?s=64&v=4){.d-block .avatar-user width="32" height="32"}](/heywoodlh){.mr-2} [**heywoodlh** Spencer Heywood](/heywoodlh){.link-gray-dark .no-underline .flex-self-center}
-   [![\@tddschn](https://avatars1.githubusercontent.com/u/45612704?s=64&v=4){.d-block .avatar-user width="32" height="32"}](/tddschn){.mr-2} [**tddschn** Ted](/tddschn){.link-gray-dark .no-underline .flex-self-center}
-   [![\@ohyhyb](https://avatars1.githubusercontent.com/u/60670030?s=64&v=4){.d-block .avatar-user width="32" height="32"}](/ohyhyb){.mr-2} [**ohyhyb** hyb](/ohyhyb){.link-gray-dark .no-underline .flex-self-center}
